...
import { links } from '../data/dummy'; // Ensure this is properly typed in its respective file
import { useStateContext } from '../contexts/ContextProvider';

// Assuming useStateContext returns typed data, if not, you'll need to define the types
...
const Sidebar: React.FC = () => {
  const { currentColor, activeMenu, setActiveMenu, screenSize } = useStateContext() as StateContextType;
